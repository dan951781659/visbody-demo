...
export const FREE_TRAINING_OPTIONS: FreeTrainingOption[] = [
  {
    ...
    title: "力量训练",
    subtitle: "增肌与力量提升",
    image: require("../../assets/training/strength.jpg"),
    features: "力量提升 · 阻力控制",
    en: { title: "Strength", subtitle: "Build muscle and strength", features: "Strength · Resistance control" },
  },
  {
    id: "pilates",
    title: "普拉提",
    subtitle: "核心控制与呼吸",
    image: require("../../assets/training/pilates.jpg"),
    features: "核心稳定 · 动作控制",
    en: { title: "Pilates", subtitle: "Core control and mindful breathing", features: "Core stability · Movement control" },
  },
  {
    id: "resistance_cardio",
    title: "阻力有氧",
    subtitle: "心肺与耐力训练",
    image: require("../../assets/training/cardio.jpg"),
    features: "心肺耐力 · 全身协同",
    en: { title: "Resistance Cardio", subtitle: "Train cardio fitness and endurance", features: "Endurance · Full-body coordination" },
  },
];
